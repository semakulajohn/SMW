angular
    .module('homer')
    .controller('PropertyEditController', ['$scope', 'ngTableParams', '$http', '$filter', '$location', '$log', '$timeout', '$modal', '$state', 'uiGridConstants', '$interval','resizeService', 'FileUploader', 'appSettingsService',
    ...
    .module('homer').controller('PropertyController', ['$scope', 'ngTableParams', '$http', '$filter', '$location', 'Utils', 'uiGridConstants',
        function ($scope, ngTableParams, $http, $filter, $location, Utils, uiGridConstants) {
            ...
            $scope.gridData.columnDefs = [
                ...
                {
                    name: 'Description', cellTemplate: '<div class="ui-grid-cell-contents"> <a href="#/properties/edit/{{row.entity.PropertyId}}/{{row.entity.MediaFolderId}}">{{row.entity.Description}}</a> </div>',
                    sort: {
